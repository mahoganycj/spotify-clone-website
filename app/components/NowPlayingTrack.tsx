  ...
  return (
    <div className='flex flex-row items-center gap-4'>
        ...
        <div className='flex flex-col gap-x-0 justify-start'>
            <div className='hover:underline cursor-pointer select-none font-semibold text-md'>Track Name</div>
            <div className='hover:underline cursor-pointer select-none text-neutral-700 text-xs font-semibold hover:text-white'>Track Artist</div>
        </div>
